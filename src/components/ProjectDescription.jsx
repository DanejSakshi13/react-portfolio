    ...
    <Carousel fade controls={false} indicators={false} >
      <Carousel.Item className="carousel">
        <div className="project-details">
          <h2 className="project-name">Podcashh</h2>
          <p style={{fontSize: "2vh"}} className="project-description">
          ...
          <div className="round-button"><a href=""><FontAwesomeIcon icon={faArrowUpRightFromSquare} className="icon"/></a></div>
      ...
      <Carousel.Item className="carousel">
        <div className="project-details">
        <h2 className="project-name">MediBridge</h2>
          <p style={{fontSize: "2vh"}} className="project-description">
      ...
      <Carousel.Item className="carousel">
        <div className="project-details">
        <h2 className="project-name">PalettePros</h2>
          <p style={{fontSize: "2vh"}} className="project-description">
